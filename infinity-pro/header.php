...
/****************************************\
# MANUALLY ADDED ON 07/17/2019
\****************************************/
echo "<div class='techreative-header'>";
echo "<div class='techreative-header-widget'>";
if ( is_active_sidebar( 'techreative-header-widget' ) ) { dynamic_sidebar( 'techreative-header-widget' ); }
echo "</div> <!-- .techreative-header-widget -->";

echo "<div class='techreative-header-image-widget'>";
if ( is_active_sidebar( 'techreative-header-image-widget' ) ) { dynamic_sidebar( 'techreative-header-image-widget' ); }
echo "</div> <!-- .techreative-header-image-widget -->";
echo "</div> <!-- .techreative-header -->";
/****************************************/
